...
\section{Latest Implementation and Result Log (through June 15, 2026)}
...
\code{README.md} reports the following result on this preset:
\begin{center}
\begin{tabular}{rrr}
\toprule
...
\end{tabular}
\end{center}
These are the numbers cited at submission time; the Myriad scripts (\S\ref{sec:stage2}) chase larger budgets for both $n$ values.
